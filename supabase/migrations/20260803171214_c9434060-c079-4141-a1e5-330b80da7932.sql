ALTER TABLE public.players ADD COLUMN IF NOT EXISTS is_rookie boolean NOT NULL DEFAULT false;
CREATE INDEX IF NOT EXISTS players_is_rookie_idx ON public.players (is_rookie);
